...
var CELL_HIGHLIGHT = '#f13044';
var ELECTRON_COLOR = '#d12553';
...
var FullscreenCanvas = function () {
    ...
    FullscreenCanvas.prototype.adjust = function adjust() {
        ...
        var innerHeight = /*320*/ _window.innerHeight; 
...
var Electron = function () {
    function Electron() {
        ...
        var lifeTime = _ref4$lifeTime === undefined ? 3 * 1500 : _ref4$lifeTime;
...
var shape = {
    ...
    getTextMatrix: function getTextMatrix(text) {
        ...
        shapeLayer.repaint(function (ctx) {
            ...
            var fontSize = Math.min(MAX_FONT_SIZE, MAX_FONT_SIZE * scale * 0.4);
